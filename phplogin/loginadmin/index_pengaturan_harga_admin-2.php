    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        fetch('get_harga-2.php')
            ...
            .then(data => {
                ...
                hargaInput.value = data.harga_bestari;
            })
...
// }
    ...
    function simpanHarga() {
        ...
        fetch('update_harga-2.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
            body: JSON.stringify({ harga_bestari: hargaBaru }),
        })
        .then(response => response.json())
        .then(data => {
            // Setelah berhasil menyimpan, Anda mungkin ingin memberikan feedback kepada pengguna
            alert('Harga berhasil disimpan: ' + data.harga_bestari);
        })
        .catch(error => console.error('Error:', error));
    }
    </script>
