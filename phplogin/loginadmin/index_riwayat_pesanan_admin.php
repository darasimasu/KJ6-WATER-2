...
<head>
    ...
    <title>Index Riwayat Pesanan Admin</title>
...
<body>
    ...
    <ul>
        ...
        <a href="index_riwayat_pesanan_admin.php" class="button-daftar-beda">
    ...
    <div id="judul-kolom-daftar-pesanan-container-print" class="judul-kolom-daftar-pesanan-container">
    ...
    <div id="total-semua-harga-container-print" class="total-semua-harga-container">
    ...
    <div class="print-button-container">
        <div class="print-button">
            <button onclick="openPopup()">Print</br>Riwayat</button>
        </div>
    </div>
...
//     const defaultOption = selectElement.options[0];
    ...
    // if (selectedIndex !== 0) {
        ...
        // localStorage.setItem(`selectedStatusRiwayatAdmin_${selectElement.dataset.id}`, selectElement.value);
    // } else {
        ...
        // localStorage.removeItem(`selectedStatusRiwayatAdmin_${selectElement.dataset.id}`);
    // }
// }
...
function searchPesanan() {
    ...
    pesananElements.forEach(function (element) {
        var username1 = element.querySelector('.card-kolom-pesanan-1').innerText.toLowerCase();
        ...
        if (username1.includes(searchValue) || alamat.includes(searchValue)) {
...
<script>
    function openPopup() {
        // Buka popup dengan ukuran lebar 400 dan tinggi 300
        window.open('popup.php', 'Popup', 'width=930,height=2100');
    }
</script>
