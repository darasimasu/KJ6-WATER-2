...
$query = "SELECT harga_bestari FROM harga_pesanan LIMIT 1"; // Ubah tabel dan nama kolom sesuai dengan struktur database Anda
...
if ($result) {
    ...
    echo json_encode($row['harga_bestari']);
} else {
    echo "Gagal mengambil data harga_bestari";
}
