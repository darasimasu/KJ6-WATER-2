...
<head>
    ...
    <style>
        ...
        .custom-button-unik {
            ...
            color: #FFF;
            padding: 10px;
            margin-right: 30px; /* Menambahkan jarak antara button */
            margin-left: 30px;
            border: none;
            cursor: pointer;
            display: flex;
...
<body>
    ...
    <div class="white-card-container">
        ...
        <div class="white-card">
            ...
            <button class="custom-button" id="airIsiUlangButton">Air Isi Ulang</button>
            <button class="custom-button" id="sanfordButton">Sanford</button>
            <button class="custom-button-unik" id="bestariButton">Bestari</button>
            ...
            <div class="blue-card">
                ...
                <div class="quantity-container">
                    ...
                    <input type="hidden" name="merek" id="merekInput" value="Bestari"> <!-- Tambahkan input hidden untuk merek -->
    ...
    <script>
        ...
        fetch('ambil_data_harga_air_isi_ulang-2.php')
