...
<head>
    ...
    <style>
        ...
        .card-black{
            ...
            border: 2px solid black; /* Batas dengan lebar 2px dan warna transparan */
            transition: background-color 0.3s, border-color 0.3s; /* Menambahkan efek transisi */
        }
        ...
        .card-black h1 {
            ...
            transition: color 0.3s; /* Menambahkan efek transisi untuk warna teks */
        }
...
<body>
    ...
    <h2 id="statusPesanan" class="background-box">
        ...
        <!-- Card with hyperlink -->
        <a href="index_status_utang.php" class="card-black">
            <h1>Utang<br>Anda</h1>
        </a>
    ...
    <script>
        ...
        function redirectToIndexStatusPesananSekarang(event) {
            ...
            setTimeout(function() {
                ...
                window.location.href = "index_status_pesanan_sekarang.php?waktu_pembuatan=" + encodeURIComponent(waktuPembuatan) + "&id=" + encodeURIComponent(idPesanan);
...
async function isDaftarPesananNotEmpty(userId) {
    try {
        ...
        xhr.open("GET", "check_daftar_pesanan.php?user_id=" + escapedUserId, true);
...
function createStatusPesananButtons(dataWaktuPembuatan) {
    ...
    for (var i = 0; i < dataWaktuPembuatan.length; i++) {
        ...
        button.onclick = redirectToIndexStatusPesananSekarang;
